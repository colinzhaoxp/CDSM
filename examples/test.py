...
from cdsm.models.dsbn import convert_dsbn, convert_bn
from cdsm.evaluators import Evaluator
...
def main_worker(args):
    ...
    sys.stdout = Logger(osp.join(log_dir, osp.basename(args.resume)[:-4] + '.txt'))
    print("==========\nArgs:{}\n==========".format(args))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', type=str,
                        default="./logs/market1501/market1501-author/resnet50_avg_cmhybrid_200iters_usl.tar",
                        metavar='PATH')
    # testing configs
