...
class Preprocessor(Dataset):
    def __init__(self, dataset, root=None, transform=None, mutual=False, base_transformer=None):
    ...
    def _get_mutual_item(self, index):
        ...
        if self.transform is not None:
            ...
            img_2 = self.base_transformer(img_2)

        return img_1, img_2, pid, camid, index