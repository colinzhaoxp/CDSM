...
def search_raw_array_pytorch(res, xb, xq, k, D=None, I=None,
    ...
    #             d, k, D_ptr, I_ptr)
    faiss_args = faiss.swigfaiss.GpuDistanceParams()
    faiss_args.metric = metric
    faiss_args.vectors = xb_ptr
    faiss_args.vectorsRowMajor = xb_row_major
    faiss_args.numVectors = nb
    faiss_args.queries = xq_ptr
    faiss_args.queriesRowMajor = xq_row_major
    faiss_args.numQueries = nq
    faiss_args.dims = d
    faiss_args.k = k
    faiss_args.outDistances = D_ptr
    faiss_args.outIndices = I_ptr
    faiss.bfKnn(res, faiss_args)
    return D, I
